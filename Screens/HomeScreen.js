...
function HomeScreen({ navigation }) {
  ...
  const fakeData =[ //name, location, time, messagem requestedItems,items,
    {key:'1', name:'Food Drive',location:'208 Ang Mo Kio Ave 1, Singapore 560208',time:'0900-1900', message:'Please only take What you need and be considerate',
    ...
    {key:'2', name:'Hand Sanitiser Galore',location:'253 Ang Mo Kio Street 21, Block 253, Singapore 560253',time:'0900-1900', message:'NIL',picture:require('../assets/handSan.jpeg'),requestedItems:'',items:[]},

    {key:'3', name:'June Giveaway',location:'244 Ang Mo Kio Ave 3, Singapore 560244',time:'0900-1900', message:'NIL',picture:require('../assets/june.jpeg'),requestedItems:'',items:[]},

    {key:'4', name:'Snacks for everyone',location:'212 Ang Mo Kio Ave 3, Block 212, Singapore 560212',time:'1400-1600', message:'NIL',picture:require('../assets/snacks.jpeg'),requestedItems:'',items:[]},

    {key:'5', name:'Have a nice day',location:'101 Ang Mo Kio Ave 3, Block 101, Singapore 560101',time:'1100-2000', message:'NIL',picture:require('../assets/niceDay.jpeg'),requestedItems:'',items:[]},
